//This is referenced from Catlike Coding's Texture Distortion tutorial:
...
Shader "Custom/Wave"
{
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
			...
			fixed4 texA = tex2D(_MainTex, uvwA.xy) * (uvwA.z * _HeightScale);
			fixed4 texB = tex2D(_MainTex, uvwB.xy) * (uvwB.z * _HeightScale);
